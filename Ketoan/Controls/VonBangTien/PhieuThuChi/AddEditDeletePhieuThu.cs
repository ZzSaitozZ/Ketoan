...
namespace Ketoan.Controls.VonBangTien.PhieuThuChi
{
...

    {
        ...
        public AddEditDeletePhieuThu(GridView gridview, bool isadd, string phieu)
        {
            ...
            txtMahd.Text = phieu;
            txtManv.Text = Gridview.GetDataRow(Gridview.FocusedRowHandle)["Ma_Nvu"].ToString();
            txtDiaChi.Text = Gridview.GetDataRow(Gridview.FocusedRowHandle)["Dia_Chi"].ToString();
            txtNgayct.Text = Gridview.GetDataRow(Gridview.FocusedRowHandle)["Ngay_Ct"].ToString();
            txtOngba.Text = Gridview.GetDataRow(Gridview.FocusedRowHandle)["Ong_Ba"].ToString();
            txtDienGiai.Text = Gridview.GetDataRow(Gridview.FocusedRowHandle)["Dien_Giai"].ToString();
        }
        ...
        private void AddEditDeletePhieuThu_Load(object sender, EventArgs e)
        {
            ...
            e00DMTKTableAdapter.Fill(ewondataset1.E00DMTK);
        ...
        private void btnDongY_Click(object sender, EventArgs e)
        {
            ...
            Gridview.GetDataRow(Gridview.FocusedRowHandle)["Ma_Ct"] = txtMahd.Text;
            Gridview.GetDataRow(Gridview.FocusedRowHandle)["Ma_Nvu"] = txtManv.Text;
            Gridview.GetDataRow(Gridview.FocusedRowHandle)["Ong_Ba"] = txtOngba.Text;
            Gridview.GetDataRow(Gridview.FocusedRowHandle)["Dia_Chi"] = txtDiaChi.Text;
            Gridview.GetDataRow(Gridview.FocusedRowHandle)["Ngay_Ct"] = txtNgayct.Text;
            Gridview.GetDataRow(Gridview.FocusedRowHandle)["Dien_Giai"] = txtDienGiai.Text;
            if (isAdd)
            {
