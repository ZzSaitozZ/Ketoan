...
{
    public partial class DMKM : Frame
    {
        public DMKM()
        {
            InitializeComponent();
        ...
        private void DMKM_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'eWONDATASET.E00DMKM' table. You can move, or remove it, as needed.
            this.e00DMKMTableAdapter.Fill(this.eWONDATASET.E00DMKM);
        ...
        private void deleteBtn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            e00DMKMTableAdapter.Update(eWONDATASET.E00DMKM);
        }
