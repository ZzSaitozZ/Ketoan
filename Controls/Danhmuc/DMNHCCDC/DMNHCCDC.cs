...
{
    public partial class DMNHCCDC : Frame
    {
        public DMNHCCDC()
        {
            InitializeComponent();
        ...
        private void DMNHCCDC_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'eWONDATASET.E00DMNHCCDC' table. You can move, or remove it, as needed.
            this.e00DMNHCCDCTableAdapter.Fill(this.eWONDATASET.E00DMNHCCDC);
        ...
        private void deleteBtn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            e00DMNHCCDCTableAdapter.Update(eWONDATASET.E00DMNHCCDC);
        }
