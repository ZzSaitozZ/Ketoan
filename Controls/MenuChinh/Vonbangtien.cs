...
namespace Ketoan.Controls
{
    public partial class Vonbangtien : UserControl
    {
        ...
        private void galleryControl2_Gallery_ItemClick(object sender, DevExpress.XtraBars.Ribbon.GalleryItemClickEventArgs e)
        {
            ...
            else if (MenuBtn.Contains("PT"))
            {
                Ketoan.Controls.VonBangTien.PhieuThuChi.FormPhieuThu frm = new Ketoan.Controls.VonBangTien.PhieuThuChi.FormPhieuThu("PT");
                frm.Text = "Phiếu thu";
                frm.Show();
                frm1.Hide();
            }
            else if (MenuBtn.Contains("PC"))
            {
                Ketoan.Controls.VonBangTien.PhieuThuChi.FormPhieuThu frm = new Ketoan.Controls.VonBangTien.PhieuThuChi.FormPhieuThu("PC");
                frm.Text = "Phiếu chi";
                frm.Show();
                frm1.Hide();
            }
