...
{
    public partial class Chiphigiathanh : UserControl
    {
        public Chiphigiathanh()
        {
            InitializeComponent();
        }
        private void galleryControl2_Gallery_ItemClick(object sender, DevExpress.XtraBars.Ribbon.GalleryItemClickEventArgs e)
        {
            ...
            else if (MenuBtn.Contains("tgtp"))
            {
                FKhaibaodinhmucsp frm = new FKhaibaodinhmucsp();
                frm.Show();
                frm1.Hide();
            }
        ...
        private void galleryControl2_Gallery_ItemClick_1(object sender, DevExpress.XtraBars.Ribbon.GalleryItemClickEventArgs e)
        {
