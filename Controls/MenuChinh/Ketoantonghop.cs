...
{
    public partial class Ketoantonghop : UserControl
    {
        public Ketoantonghop()
        {
            InitializeComponent();
        }
        private void galleryControl2_Gallery_ItemClick(object sender, DevExpress.XtraBars.Ribbon.GalleryItemClickEventArgs e)
        {
            ...
            s.k++;
            #region Menuchinh
            string Menuchinh = MenuBtn.Substring(5);
            switch (Menuchinh)
            {
                case "btkc":
                    //statements 
                    {
                        FButtoanketchuyen form = new FButtoanketchuyen(Menuchinh);
                        form.Show();
