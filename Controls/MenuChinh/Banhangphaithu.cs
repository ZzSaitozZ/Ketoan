...
{
    public partial class Banhangphaithu : UserControl
    {
        public Banhangphaithu()
        {
            InitializeComponent();
        }
        private void galleryControl2_Gallery_ItemClick(object sender, DevExpress.XtraBars.Ribbon.GalleryItemClickEventArgs e)
        {
            ...
            {
                FBaocaomuahang frm = new FBaocaomuahang("bcmh");
                frm.Text = "Báo cáo bán hàng";
                frm.Show();
                frm1.Hide();


            }
            else if (MenuBtn.Contains("HDBH"))
            {
                FBanHangPhaiThu frm = new FBanHangPhaiThu();
                frm.Text = "Bán hàng phải thu";
                frm.Show();
                frm1.Hide();
        ...
        private void Banhangphaithu_Load(object sender, EventArgs e)
        {
